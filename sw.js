const CACHE_NAME = 'kiyamul-leyl-v7';
const APP_SHELL = [
    './',
    './index.html',
    './manifest.json',
...
self.addEventListener('fetch', (event) => {
    ...
    // Diyanet vakit API'si gibi farklı origin istekleri SW'nin kapsamı
    // dışında kalsın; tarayıcı bunları doğrudan, SW araya girmeden yürütsün.
...
// buna bağlı yanlış "çevrimdışı" hatası ya da yavaş açılış artık söz
// konusu değil. Güncelleme arka planda sessizce indirilip önbelleğe
// yazılır; kullanıcı bunu beklemez, güncel sürümü bir sonraki açılışta
// görür.
